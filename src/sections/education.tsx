...
export default function Education() {
  ...
  return (
    <section id="education" className="py-8 px-4 sm:px-6 -mt-0 md:px-12 lg:px-20 mb-0">
      <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">{t("education.title")}</h2>
